...
<p>Перечень и базовая стоимость услуг опубликованы на странице <a href="/prices.php">«Стоимость услуг»</a>. Точная цена рассчитывается с учётом расстояния, выбранной техники, сложности погрузки и дополнительных работ и сообщается клиенту до подтверждения выполнения заказа.</p>
...
<p>До подтверждения банком платёж считается незавершённым. Повторное списание по одному заказу блокируется системой. Электронный чек направляется на телефон или email, указанный клиентом при оформлении заказа.</p>
<p>Для отменённого до начала выполнения заказа онлайн-платежа оформляется полный возврат. После начала выполнения возможен полный или частичный возврат с учётом фактически оказанных услуг и понесённых расходов. Возврат выполняется на тот же способ оплаты; срок зачисления зависит от банка покупателя. Для обращения укажите номер заказа по телефону или email службы поддержки.</p>
<?php else:?>
...
<p class="muted">Актуальная редакция документов действует с 11 сентября 2026 года.</p>
</div></div></body></html>
