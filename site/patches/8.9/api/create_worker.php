...
$w=array('id'=>$id,'token'=>$token,'name'=>$name,'phone'=>$phone,'vehicle_type'=>$vehicle,'services'=>$services,'status'=>'offline','lat'=>'','lng'=>'','last_seen'=>'','created_at'=>date('c'),'rating'=>5.0,'commission'=>20);
