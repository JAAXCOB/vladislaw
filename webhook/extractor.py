...
- true — ТОЛЬКО если сообщение явно говорит, что заявка закрыта/выполнена. Формулировки бывают
  очень разговорными и корявыми, распознавай смысл, а не точную фразу. Примеры того, что значит
  "закрыто": "заявка закрыта", "закрыл", "сдал", "выполнено", "готово", "отработали", "все ок сдано",
  "забрал и отвёз", "поставил на стоянку", "довёз", "машина на месте", "закрыта заявка", "затарил на стоянку",
  "все, привезли", "выполнил заказ" и любые похожие по смыслу формулировки о завершении работы.
